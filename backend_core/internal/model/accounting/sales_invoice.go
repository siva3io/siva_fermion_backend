...
type SalesInvoice struct {
	...
	ExpectedShipmentDate     time.Time               `json:"expected_shipment_date" gorm:"type:time"`
	...
	Channel                  omnichannel.Marketplace `json:"channel" gorm:"foreignKey:ChannelID; references:ID"`
...
type SalesInvoiceLines struct {
	...
	Quantity         uint                                  `json:"quantity" gorm:"type:integer"`
