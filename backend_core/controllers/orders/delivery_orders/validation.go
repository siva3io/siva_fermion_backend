...
*/
func (a DeliveryOrderRequest) Validate() error {
...
func (o DeliveryOrdersDetails) Validate() error {
...
func (o DeliveryOrderLines) Validate() error {
	return validation.ValidateStruct(&o,
...
func DeliveryOrdersCreateValidate(next echo.HandlerFunc) echo.HandlerFunc {
	...
	return func(c echo.Context) error {
		...
		c.Set("delivery_orders", data)
		return next(c)
	}
}

func DeliveryOrdersUpdateValidate(next echo.HandlerFunc) echo.HandlerFunc {
