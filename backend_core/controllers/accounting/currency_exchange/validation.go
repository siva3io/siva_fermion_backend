...
func CurrencyExchangeCreateValidate(next echo.HandlerFunc) echo.HandlerFunc {

	var data = new(accounting.CurrencyExchange)
	return func(c echo.Context) error {
		...
		c.Set("currency_exchange", data)
		return next(c)
	}
}

func CurrencyExchangeUpdateValidate(next echo.HandlerFunc) echo.HandlerFunc {
