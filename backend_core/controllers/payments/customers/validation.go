...
*/
func CustomersCreateValidate(next echo.HandlerFunc) echo.HandlerFunc {

	var data = new(payments.Customers)
	return func(c echo.Context) error {
		...
		c.Set("customers", data)
		return next(c)
	}
}

func CustomersUpdateValidate(next echo.HandlerFunc) echo.HandlerFunc {
