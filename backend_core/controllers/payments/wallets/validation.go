...
*/
func WalletCreateValidate(next echo.HandlerFunc) echo.HandlerFunc {

	var data = new(payments.Wallets)
...
func WalletUpdateValidate(next echo.HandlerFunc) echo.HandlerFunc {
