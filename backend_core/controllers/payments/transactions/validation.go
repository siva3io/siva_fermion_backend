...
*/
func TransactionsCreateValidate(next echo.HandlerFunc) echo.HandlerFunc {

	var data = new(payments.Transactions)
	return func(c echo.Context) error {
		...
		c.Set("transactions", data)
		return next(c)
	}
}

func TransactionsUpdateValidate(next echo.HandlerFunc) echo.HandlerFunc {
