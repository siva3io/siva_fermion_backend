...
func WebstoresCreateValidate(next echo.HandlerFunc) echo.HandlerFunc {

	var data = new(omnichannel.User_Webstore_Link)
	return func(c echo.Context) error {
		...
		c.Set("webstores", data)
		return next(c)
	}
}

func WebstoresUpdateValidate(next echo.HandlerFunc) echo.HandlerFunc {
