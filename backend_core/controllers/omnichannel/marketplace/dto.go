...
*/
// type Marketplace_user_details struct {
...
type (
	Marketplace_Request struct {
		MarketPlace_id uint      `json:"marketplace_id"`
		Full_name      string    `json:"full_name"`
		Email          string    `json:"email"`
		Mobile_no      int64     `json:"mobile_no" `
		Date_of_birth  string    `json:"date_of_birth"`
...
type (
	MarketplaceCreateResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplaceCreateResponse
)

// Update Marketplace response
type (
	MarketplacedetailUpdateResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplacedetailUpdateResponse
)

// Get  Marketplace response
type (
	MarketplaceGetResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplaceGetResponse
)

type (
	MarketplaceGetAllResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data []Marketplace_Request
		}
	} //@ name MarketplaceGetAllResponse
)

// Delete Delivery Order response
type (
	MarketplaceDeleteResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplaceDeleteResponse
)

// Delete Deliver Orderlines response
type (
	MarketplaceLinesDeleteResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplaceLinesDeleteResponse
)

// ________________________________

type (
	Marketplace_Details struct {
		MarketPlace_id                 uint                           `json:"marketplace_id"`
...
// Create Marketplace response
type (
	MarketplacedetailCreateResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplacedetailCreateResponse
)

// Update Marketplace response
type (
	MarketplaceUpdateResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplaceUpdateResponse
)

// Get  Marketplace response
type (
	MarketplacedetailGetResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplacedetailGetResponse
)

type (
	MarketplacedetailGetAllResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data []Marketplace_Details
		}
	} //@ name MarketplacedetailGetAllResponse
)

// Delete Delivery Order response
type (
	MarketplacedetailDeleteResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data interface{}
		}
	} //@ name MarketplacedetailDeleteResponse
)

type (
	AvailableMarketPlacesResponse struct {
		Body struct {
			Meta response.MetaResponse
			Data []Marketplace
		}
	} //@ name AvailableMarketPlacesResponse
)

type ThirdPartyMarketPlaceResponseDTO struct {
