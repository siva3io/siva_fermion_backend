...
func (h *handler) Route(g *echo.Group) {
	...
	g.POST("/create", h.CreateSalesReturns, cmiddleware.Authorization, SalesReturnsCreateValidate)
	g.POST("/:id/update", h.UpdateSalesReturns, cmiddleware.Authorization, SalesReturnsUpdateValidate)
